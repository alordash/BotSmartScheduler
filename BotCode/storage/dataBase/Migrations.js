...
class Migrations {
   static async InitializeTables() {
      await Connector.instance.Query('CREATE TABLE IF NOT EXISTS schedules (ChatID TEXT, num INTEGER, text TEXT, username TEXT, target_date BIGINT, period_time BIGINT, max_date BIGINT, file_id TEXT, trello_card_id TEXT, id SERIAL, pending BOOLEAN DEFAULT false, message_id INT, creation_date BIGINT)');
